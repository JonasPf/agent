  ...
  "paths": {
    ...
    "/sessions/{id}/cancel": {
      ...
      "post": {
        ...
        "summary": "Stop the turn this session is running. A turn runs for as long as its work takes; this ends one where it is, and the transcript says it was stopped.",
        "responses": {
          "200": {
            "description": "The turn was stopped."
          },
          "404": {
            "description": "No such session."
          },
          "409": {
            "description": "This session is not working on anything."
          }
        }
      }
    },
    ...
    "/skills": {
      ...
      "post": {
        ...
        "description": "The operator writes skills; the agent cannot. The file is stored outside the image, so it survives a deployment. A name that collides with a skill shipping in the image is refused.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
        ...
        "responses": {
          ...
          "409": {
            "description": "Refused: the name collides with a shipped skill, or a required field is missing."
          }
        }
      }
    },
    "/skills/{name}": {
      "get": {
        ...
        "summary": "Read a skill's full text.",
        "responses": {
          "200": {
      ...
      "put": {
        ...
        "summary": "Replace a skill the operator wrote.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
        ...
        "responses": {
          ...
          "409": {
            "description": "Refused: the skill ships in the image, or a required field is missing."
          }
        }
      },
      "delete": {
        ...
        "summary": "Delete a skill the operator wrote.",
        "responses": {
          "204": {
            "description": "Deleted."
          },
          "409": {
            "description": "Refused: the skill ships in the image, or there is no such skill."
          }
        }
      }
    },
    "/personas": {
      "get": {
        ...
        "summary": "List personas. The built-in one is always among them.",
        "responses": {
          "200": {
      ...
      "post": {
        ...
        "summary": "Write a persona.",
        "description": "A persona is the opening section of the system prompt. A session that chooses one gets it in place of the built-in persona entirely.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
        ...
        "responses": {
          ...
          "409": {
            "description": "Refused: the name is the built-in persona's, or a required field is missing."
          }
        }
      }
    },
    "/personas/{name}": {
      "get": {
        ...
        "summary": "Read a persona's full text.",
        "responses": {
          "200": {
      ...
      "put": {
        ...
        "summary": "Replace a persona the operator wrote.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
        ...
        "responses": {
          ...
          "409": {
            "description": "Refused: the persona is the built-in one, or a required field is missing."
          }
        }
      },
      "delete": {
        ...
        "summary": "Delete a persona the operator wrote.",
        "responses": {
          "204": {
            "description": "Deleted."
          },
          "409": {
            "description": "Refused: the persona is the built-in one, or there is no such persona."
          }
        }
      }
    },
    ...
    "schemas": {
      ...
      "Skill": {
        ...
        "properties": {
          ...
          "default_enabled": {
            "type": "boolean",
            "description": "Whether a session that did not choose its skills has this one. False when the frontmatter says default: off."
          },
          "enabled": {
            "type": "boolean",
            "description": "With ?session_id=, whether that session has it; otherwise the default."
          },
          "editable": {
            "type": "boolean",
            "description": "Whether the operator wrote this one. A skill that ships in the image is read-only."
          }
        }
      },
      "SkillWrite": {
        ...
        "properties": {
          "name": {
            "type": "string",
            "description": "Letters, digits, hyphens, and underscores. It is the identifier and the file name."
          },
          "description": {
            "type": "string",
            "description": "One line. This and the name are all that reach the system prompt."
          },
          "body": {
            "type": "string",
            "description": "The prose the agent reads when it opens the skill."
          },
          "default_enabled": {
            "type": "boolean",
            "description": "Whether a session that did not choose its skills has this one. Defaults to true."
          }
        }
      },
      "Persona": {
        ...
        "properties": {
          ...
          "description": {
            "type": "string",
            "description": "One line, so personas can be told apart when a conversation is configured."
          },
          "bytes": {
            "type": "integer"
          },
          "editable": {
            "type": "boolean",
            "description": "Whether the operator wrote this one. The built-in persona is read-only."
          }
        }
      },
      "PersonaWrite": {
        ...
        "properties": {
          ...
          "body": {
            "type": "string",
            "description": "The whole opening section of the system prompt for a session that chooses this persona."
          }
        }
      }
    }
